        ...
        <div id="line-one">   
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">   
                        <br />
                        <h4 id="center"><b>CADASTRO DE ALUNO</b></h4>
                        <br>
                        <div class="table-responsive">
                            <form method="post" action="{{route('aluno.store')}}" enctype="multipart/form-data">{{ csrf_field() }}

	                        <div class="col-md-12">              
	                            <div class="form-group" class="col-md-6">
	                                <label for="name">Nome do Curso</label>
	                                <input type="text" name="name" class="form-control form" placeholder="Ex: Fulano de Tal" required>
	                            </div>
	                        </div>
                            <div class="col-md-12">
                                <div class="form-group" class="col-md-6">
                                    <label for="email">Email</label>
                                    <input type="email" name="email" class="form-control form" placeholder="Ex: email@teste.com" required>
                                </div>
                            </div>   
                            <div class="col-md-12">
                                <div class="form-group" class="col-md-6">
                                    <label for="nascimento">Data de Nascimento</label>
                                    <input type="text" name="birth" class="form-control form" placeholder="Ex: 12/12/2012" required>
                                </div>
                            </div>     
                            <div class="col-md-12">
                                <div class="form-group" class="col-md-6">
