                ...
                <div class="row">
                    <div class="col-md-12">   
                        ...
                        <div class="table-responsive">
                            <form method="post" action="{{route('curso.update', $curso->id)}}" enctype="multipart/form-data">{!! method_field('put') !!}{{ csrf_field() }}

	                        <div class="col-md-12">              
	                            <div class="form-group" class="col-md-6">
	                                <label for="name">Nome do Curso</label>
	                                <input type="text" name="course" class="form-control form" value="{{$curso->course}}" required>
	                            </div>
	                        </div>
	                        <div class="col-md-12">
	                            <div class="form-group" class="col-md-6">
	                                <label for="description">Descrição</label>
	                                <input type="text" name="description" class="form-control form" value="{{$curso->description}}">
	                            </div>
	                        </div>                       
	                        <div class="col-md-12">                   
