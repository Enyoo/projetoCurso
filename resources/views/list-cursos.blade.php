                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td title="Nome">{{$curso->course}}</td>
                                        <td title="Descrição">{{$curso->description}}</td>
                                        @php
                                            $i=0
                                        @endphp
                                        @foreach($alunos as $aluno)
                                            ...
                                            @endif
                                        @endforeach
                                        <td title="Quantidade" id="center">{{$i}}</td>
                                        <td id="center">
                                        ...
                                        <td id="center">
                                            ...
                                            <form style="display: inline-block;" method="POST" action="{{route('curso.destroy', $curso->id)}}" data-toggle="tooltip" data-placement="top" title="Excluir" onsubmit="return confirm('Confirma exclusão?')">
